    ...
    <div className="bg-white rounded-xl border border-slate-200 shadow-sm h-full flex flex-col">
      ...
      <div className="flex-1 overflow-auto p-4 space-y-4">
        {subjects?.map(subject => (
          <div key={subject._id} className="p-4 rounded-xl border border-slate-200 hover:border-indigo-300 hover:shadow-md transition-all group">
            ...
            <p className="text-sm text-indigo-600 font-medium mb-3">Assigned to:
{
  ...
  'Not Assigned'
            ...
            <div className="flex items-center gap-4 text-xs font-medium text-slate-500 border-t border-slate-100 pt-3">
              <span className="flex items-center gap-1.5"><Users className="w-3.5 h-3.5" /> {subject.sections}</span>
