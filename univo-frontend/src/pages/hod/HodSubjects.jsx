...
import { getSubjectAllocations } from '../../services/hodService';
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          <SubjectManagement subjects={subjects} loading={loading} />
        </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
            ...
            <form className="space-y-4">
              <div>
                ...
                <select className="w-full border border-slate-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-emerald-500 bg-white">
                  <option>Operating Systems (CS402)</option>
                  <option>Machine Learning (CS405)</option>
                </select>
              </div>
              <div>
              ...
              <div>
                ...
                <input type="text" placeholder="e.g. CS-A, CS-B" className="w-full border border-slate-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-emerald-500" />
              </div>
              <button type="button" className="w-full bg-slate-800 text-white rounded-lg py-2 font-medium hover:bg-slate-900 transition-colors mt-2">
                Save Allocation
              </button>
            </form>
          </div>
